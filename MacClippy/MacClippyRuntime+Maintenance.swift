...
extension MacClippyRuntime {
    ...
    func capture(
        ...
        measureDiagnosticMetric("capture") {
            ...
            // Persist every representation the observer delivered. Exclusion of
            // concealed/transient/autogenerated UTIs and excluded apps happens
            // in PasteboardObserver using MacClippyCaptureExclusionRules — not
            // here. The write sentinel already dropped Mac Clippy's own writes.
