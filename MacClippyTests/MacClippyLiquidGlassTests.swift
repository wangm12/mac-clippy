...
final class MacClippyLiquidGlassTests: XCTestCase {
    ...
    func testDockNavSourcesUsePieceGlassAndKeepCarouselEdgeFade() throws {
        ...
        XCTAssertTrue(search.contains("MacClippyDockTheme.muted2Color"))
        XCTAssertTrue(search.contains("macClippySearchFieldStyle"))
        XCTAssertTrue(search.contains("hoveredSearch"))
        XCTAssertTrue(search.contains("searchFieldEdge"))
        XCTAssertTrue(search.contains("searchFocusRing"))
        XCTAssertTrue(search.contains("searchFocusGlow"))
        XCTAssertFalse(search.contains("interactiveFocusBorder"))
        XCTAssertFalse(search.contains("macClippySearchGlass"))
        ...
        XCTAssertTrue(filters.contains("glassID: \"newCategory\""))
        XCTAssertTrue(filters.contains("macClippyGlassEffectID"))
